(function (global) {
    function startScreensaver(options = {}) {
        ...
        function showScreensaver() {
            ...
            animate()
            if (typeof changeLinkColors === 'function') changeLinkColors()
        }
        ...
        function animate() {
            ...
            function moveText() {
                ...
                if (screensaver.style.display === 'block') requestAnimationFrame(moveText)
            }
    ...
    if (typeof module !== 'undefined' && typeof module.exports !== 'undefined') {
        module.exports = { startScreensaver }
    } else if (typeof define === 'function' && define.amd) {
        define([], function () {
            return { startScreensaver }
        })
    } else {
        global.startScreensaver = startScreensaver
